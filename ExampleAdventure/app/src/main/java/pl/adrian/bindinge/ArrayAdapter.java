...
public class ArrayAdapter<ViewType extends View, ModelType> extends BaseAdapter {
    ...
    public ArrayAdapter(Class<ViewType> viewClass, ModelBinder<ViewType, ModelType> binder, ViewFactory<ViewType> viewFactory, Context context, List<ModelType> objects) {
